...
<div class='relative px-6 pt-14 lg:px-8'>
    <div class='mx-auto max-w-2xl py-8'>
        ...
        <div class='text-center'>
            ...
            <span class="p-3 bg-gradient-to-r from-blue-500 to-emerald-400 rounded-lg font-semibold max-sm:text-sm">
            ...
            />
                <div on:mousedown={() => window.location.href = "/grades"}
                     on:keydown={() => window.location.href = "/grades"}
                     class="block rounded-lg bg-gradient-to-r from-purple-50 to-blue-50 p-4 shadow-sm cursor-pointer">
