...
def fetch_professor_data(legacyId):
...
for edge in data['data']['search']['teachers']['edges']:
    ...
    detailed_info = fetch_professor_data(legacy_id)
    all_professors_details.append({"id": legacy_id, "data": detailed_info['data']})
